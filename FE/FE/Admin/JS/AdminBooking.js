document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayBookings(bookings) {
        ...
        bookings.forEach(booking => {
            ...
            row.innerHTML = `
                ...
                <td>
                    ...
                    <button class="btn-delete dlBooking btn-danger btn-sm" data-id="${booking.id}">Xóa</button>
                </td>
            `;
        ...
        document.querySelectorAll('.dlBooking').forEach(button => button.addEventListener('click', handleDeleteClick));
    }
