document.addEventListener("DOMContentLoaded", () => {
    ...
    function populateRoomTypeDropdown(roomTypes) {
        ...
        roomTypeDropdown.innerHTML = '<option value="all">Tất cả các phòng</option>'; 
         // Add default option

           // Add "đang sử dụng" option
    const inUseOption = document.createElement('option');
    inUseOption.value = 'room_active';
    inUseOption.textContent = 'Đang sử dụng';
    roomTypeDropdown.appendChild(inUseOption);
